...
Feature: Working Capital Loan Repayment
  ...
  Scenario: Verify working capital loan repayment - UC1: simple repayment: pay more than expected
    ...
    Then Working Capital loan amortization schedule has 177 periods, with the following data for periods:
      ...
      | 1         | 02 January 2026  | 50.00                 | 270.00              | 8950.00         | 0.00                       | 0.00                     | 0.00                       |
  ...
  Scenario: Verify working capital loan repayment - UC2: simple repayment by loan external ID: pay less than expected
    ...
    Then Working Capital loan amortization schedule has 182 periods, with the following data for periods:
      | paymentNo | paymentDate      | expectedPaymentAmount | actualPaymentAmount | expectedBalance | expectedAmortizationAmount | actualAmortizationAmount | expectedDiscountFeeBalance |
      | 0         | 01 January 2026  | -9000.00              |                     | 9000.00         |                            |                          | 0.00                       |
      | 1         | 02 January 2026  | 50.00                 | 30.00               | 8950.00         | 0.00                       | 0.00                     | 0.00                       |
      | 2         | 03 January 2026  | 50.00                 |                     | 8900.00         | 0.00                       |                          | 0.00                       |
      | 3         | 04 January 2026  | 50.00                 |                     | 8850.00         | 0.00                       |                          | 0.00                       |
      | 4         | 05 January 2026  | 50.00                 |                     | 8800.00         | 0.00                       |                          | 0.00                       |
      | 5         | 06 January 2026  | 50.00                 |                     | 8750.00         | 0.00                       |                          | 0.00                       |
  ...
  Scenario: Verify working capital loan repayment - UC6: full expectedAmount repaid on disbursement day
    ...
    Then Working Capital loan amortization schedule has 181 periods, with the following data for periods:
      | paymentNo | paymentDate      | expectedPaymentAmount | actualPaymentAmount | expectedBalance | expectedAmortizationAmount | actualAmortizationAmount | expectedDiscountFeeBalance |
      | 0         | 01 January 2026  | -9000.00              |                     | 9000.00         |                            |                          | 0.00                       |
      | 1         | 01 January 2026  | 50.00                 | 50.00               | 8950.00         | 0.00                       | 0.00                     | 0.00                       |
...
#   --- Full expectedAmount paid in 2 payments on the same day---
    ...
    Then Working Capital loan amortization schedule has 178 periods, with the following data for periods:
      | paymentNo | paymentDate      | expectedPaymentAmount | actualPaymentAmount | expectedBalance | expectedAmortizationAmount | actualAmortizationAmount | expectedDiscountFeeBalance |
      | 0         | 01 January 2026  | -9000.00              |                     | 9000.00         |                            |                          | 0.00                       |
      | 1         | 02 January 2026  | 50.00                 | 170.00              | 8950.00         | 0.00                       | 0.00                     | 0.00                       |
      | 2         | 03 January 2026  | 50.00                 | 100.00              | 8900.00         | 0.00                       | 0.00                     | 0.00                       |
      | 3         | 04 January 2026  | 50.00                 |                     | 8850.00         | 0.00                       |                          | 0.00                       |
      | 4         | 05 January 2026  | 50.00                 |                     | 8800.00         | 0.00                       |                          | 0.00                       |
      | 5         | 06 January 2026  | 50.00                 |                     | 8750.00         | 0.00                       |                          | 0.00                       |
      | 6         | 07 January 2026  | 50.00                 |                     | 8700.00         | 0.00                       |                          | 0.00                       |
...
#   --- Start of 2nd period ---
  ...
  Scenario: Verify working capital loan repayment - UC14: expectedAmount overpaid in 1st period
    ...
    And Delinquency Tag History for Working Capital loan has lines:
      | periodNumber | addedOnDate | liftedOnDate | classification | minimumAgeDays | maximumAgeDays |
    Then Working Capital loan amortization schedule has 175 periods, with the following data for periods:
      | paymentNo | paymentDate      | expectedPaymentAmount | actualPaymentAmount | expectedBalance | expectedAmortizationAmount | actualAmortizationAmount | expectedDiscountFeeBalance |
      | 0         | 01 January 2026  | -9000.00              |                     | 9000.00         |                            |                          | 0.00                       |
      | 1         | 02 January 2026  | 50.00                 | 370.00              | 8950.00         | 0.00                       | 0.00                     | 0.00                       |
      | 2         | 03 January 2026  | 50.00                 |                     | 8900.00         | 0.00                       |                          | 0.00                       |
      | 3         | 04 January 2026  | 50.00                 |                     | 8850.00         | 0.00                       |                          | 0.00                       |
      | 4         | 05 January 2026  | 50.00                 |                     | 8800.00         | 0.00                       |                          | 0.00                       |
      | 5         | 06 January 2026  | 50.00                 |                     | 8750.00         | 0.00                       |                          | 0.00                       |
...
#   --- Late period ---
    ...
    Then Working Capital loan amortization schedule has 152 periods, with the following data for periods:
      | paymentNo | paymentDate      | expectedPaymentAmount | actualPaymentAmount | expectedBalance | expectedAmortizationAmount | actualAmortizationAmount | expectedDiscountFeeBalance |
      | 0         | 01 January 2026  | -9000.00              |                     | 9000.00         |                            |                          | 0.00                       |
      | 1         | 02 January 2026  | 50.00                 | 1500.00             | 8950.00         | 0.00                       | 0.00                     | 0.00                       |
      | 2         | 03 January 2026  | 50.00                 |                     | 8900.00         | 0.00                       |                          | 0.00                       |
      | 3         | 04 January 2026  | 50.00                 |                     | 8850.00         | 0.00                       |                          | 0.00                       |
      | 4         | 05 January 2026  | 50.00                 |                     | 8800.00         | 0.00                       |                          | 0.00                       |
      | 5         | 06 January 2026  | 50.00                 |                     | 8750.00         | 0.00                       |                          | 0.00                       |
  ...
  Scenario: Verify amortization schedule after repayment transaction - UC18
    ...
    Then Working Capital loan amortization schedule has 201 periods, with the following data for periods:
      | paymentNo | paymentDate      | expectedPaymentAmount | actualPaymentAmount | expectedBalance | expectedAmortizationAmount | actualAmortizationAmount | expectedDiscountFeeBalance |
      | 0         | 01 January 2019  | -9000.00              |                     | 9000.00         |                            |                          | 1000.00                    |
      | 1         | 02 January 2019  | 50.00                 | 50.00               | 8959.61         | 9.61                       | 9.61                     | 990.39                     |
      | 2         | 03 January 2019  | 50.00                 | 50.00               | 8919.18         | 9.57                       | 9.57                     | 980.82                     |
      | 3         | 04 January 2019  | 50.00                 | 50.00               | 8878.70         | 9.52                       | 9.52                     | 971.30                     |
      | 4         | 05 January 2019  | 50.00                 |                     | 8838.18         | 9.48                       |                          | 961.82                     |
      | 5         | 06 January 2019  | 50.00                 |                     | 8797.62         | 9.44                       |                          | 952.38                     |
      | 6         | 07 January 2019  | 50.00                 |                     | 8757.01         | 9.39                       |                          | 942.99                     |
      | 7         | 08 January 2019  | 50.00                 |                     | 8716.36         | 9.35                       |                          | 933.64                     |
