...
# --- undo re-amortization transaction --- #
    ...
    Then Loan Repayment schedule has 6 periods, with the following data for periods:
      ...
      | 4  | 30   | 01 May 2024      |                  | 75.61           | 37.62         | 0.37     | 0.0  | 0.0       | 37.99 | 0.0   | 0.0        | 0.0  | 37.99       |
      | 5  | 31   | 01 June 2024     |                  | 37.87           | 37.74         | 0.25     | 0.0  | 0.0       | 37.99 | 0.0   | 0.0        | 0.0  | 37.99       |
      | 6  | 30   | 01 July 2024     |                  | 0.0             | 37.87         | 0.12     | 0.0  | 0.0       | 37.99 | 0.0   | 0.0        | 0.0  | 37.99       |
    And Loan Repayment schedule has the following data in Total row:
      | Principal due | Interest | Fees | Penalties | Due    | Paid  | In advance | Late | Outstanding |
      | 150.0         | 2.3      | 0.0  | 0.0       | 152.3  | 17.01 | 0.0        | 0.0  | 135.29      |
    And Loan Transactions tab has the following data:
      | Transaction date | Transaction Type | Amount | Principal | Interest | Fees | Penalties | Loan Balance | Reverted | Replayed |
      | 01 January 2024  | Disbursement     | 100.0  | 0.0       | 0.0      | 0.0  | 0.0       | 100.0        | false    | false    |
      | 01 February 2024 | Repayment        | 17.01  | 16.43     | 0.58     | 0.0  | 0.0       | 83.57        | false    | false    |
...
# --- 2nd disbursement --- #
    ...
    Then Loan Repayment schedule has 8 periods, with the following data for periods:
      ...
      | 6  | 30   | 01 May 2024      |                  | 69.03           | 15.62         | 0.37     | 0.0  | 0.0       | 15.99 | 0.0   | 0.0        | 0.0  | 15.99       |
      | 7  | 31   | 01 June 2024     |                  | 53.31           | 15.72         | 0.27     | 0.0  | 0.0       | 15.99 | 0.0   | 0.0        | 0.0  | 15.99       |
      | 8  | 30   | 01 July 2024     |                  | 37.5            | 15.81         | 0.18     | 0.0  | 0.0       | 15.99 | 0.0   | 0.0        | 0.0  | 15.99       |
    And Loan Repayment schedule has the following data in Total row:
      | Principal due | Interest | Fees | Penalties | Due    | Paid  | In advance | Late | Outstanding |
      | 112.5         | 1.72     | 0.0  | 0.0       | 114.22 | 50.26 | 0.0        | 0.0  | 63.96      |
    Then Loan Transactions tab has the following data:
      | Transaction date | Transaction Type | Amount | Principal | Interest | Fees | Penalties | Loan Balance | Reverted | Replayed |
      | 01 January 2024  | Disbursement     | 100.0  | 0.0       | 0.0      | 0.0  | 0.0       | 100.0        | false    | false    |
      | 01 January 2024  | Down Payment     | 25.0   | 25.0      | 0.0      | 0.0  | 0.0       | 75.0         | false    | false    |
