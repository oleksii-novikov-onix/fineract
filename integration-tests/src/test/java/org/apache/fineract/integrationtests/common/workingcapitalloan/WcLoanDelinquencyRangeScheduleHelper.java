...
@Slf4j
public final class WcLoanDelinquencyRangeScheduleHelper {
    ...
    private WcLoanDelinquencyRangeScheduleHelper() {}

    public static List<WcLoanDelinquencyRangeScheduleData> getDelinquencyRangeSchedule(final Long loanId) {
