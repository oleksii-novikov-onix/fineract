...
import org.apache.fineract.portfolio.workingcapitalloan.service.WcLoanDelinquencyActionReadService;
...
public class WcLoanDelinquencyActionApiResource {

    private static final String RESOURCE_NAME_FOR_PERMISSIONS = "WC_DELINQUENCY_ACTION";

    private final PlatformSecurityContext context;
    private final PortfolioCommandSourceWritePlatformService commandsSourceWritePlatformService;
    private final WcLoanDelinquencyActionReadService readService;
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(array = @ArraySchema(schema = @Schema(implementation = WcLoanDelinquencyActionData.class)))) })
    public List<WcLoanDelinquencyActionData> retrieveDelinquencyActions(
