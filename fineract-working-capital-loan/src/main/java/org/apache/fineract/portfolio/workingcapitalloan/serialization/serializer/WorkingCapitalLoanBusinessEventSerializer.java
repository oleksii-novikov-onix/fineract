...
public class WorkingCapitalLoanBusinessEventSerializer
    ...
    private static final List<LoanTransactionType> REPAYMENT_LIKE_TRANSACTION_TYPES = LoanTransactionType
            .getRepaymentLikeTransactionTypes();
    ...
    private void populateSummaryTransactionTypeTotals(final WorkingCapitalLoan loan, final WorkingCapitalLoanAccountDataV1 result) {
        ...
        summary.setTotalPayment(sumOf(totals, REPAYMENT_LIKE_TRANSACTION_TYPES, false));
        summary.setTotalPaymentReversed(sumOf(totals, REPAYMENT_LIKE_TRANSACTION_TYPES, true));
    }
    ...
    private void populateBreachSchedule(final WorkingCapitalLoan loan, final WorkingCapitalLoanAccountDataV1 result) {
        ...
        balanceRepository.findByWcLoan_Id(loan.getId())
                .ifPresent(balance -> breach.setBreachPastDueAmount(balance.getBreachPastDueAmount()));
    }
