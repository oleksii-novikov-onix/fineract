...
public class WCProductAccountingMappingServiceImpl implements WCProductAccountingMappingService {

    private final WCLoanProductToGLAccountMappingHelper mappingHelper;
    ...
    public void createAccountMapping(final Long wcLoanProductId, final JsonCommand command) {
        ...
        final WCAccountingRuleType accountingRuleType = WCAccountingRuleType.valueOf(accountingRuleValue);
    ...
    public Map<String, Object> updateAccountMapping(final Long wcLoanProductId, final JsonCommand command,
            final boolean accountingRuleChanged, final WCAccountingRuleType accountingRuleType) {
        Map<String, Object> changes = new HashMap<>();
        final JsonElement element = this.fromApiJsonHelper.parse(command.json());

        if (accountingRuleChanged) {
            this.mappingHelper.deleteProductToGLAccountMapping(wcLoanProductId);
            createAccountMapping(wcLoanProductId, command);
            if (accountingRuleType.isCashBased()) {
    ...
    public Map<String, Object> fetchAccountMappingDetails(final Long wcLoanProductId, final WCAccountingRuleType accountingRuleType) {
